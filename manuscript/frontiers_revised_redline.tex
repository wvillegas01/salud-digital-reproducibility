...
%DIF DEL C:\Users\wilop\Dropbox\MPDI\2026\Salud-digital\Revisiones\salud-digital-reproducibility-package\manuscript\frontiers_revised.tex   Wed Sep 16 08:35:40 2026
%DIF ADD frontiers_clean.tex                                                                                                                Wed Sep 16 09:17:23 2026
...
The explicit source mappings used for the primary shared-feature extraction are summarized in \DIFaddbegin \DIFadd{Table 1. }\DIFaddend MIMIC laboratory variables were selected by item identifier from \texttt{LABEVENTS}, and vital signs were selected by item identifier from \texttt{CHARTEVENTS}. Creatinine was restricted to the blood/serum/plasma laboratory item represented by MIMIC item ID 50912 and the exact eICU laboratory name \texttt{creatinine}; urinary creatinine and protein/creatinine-ratio measurements were not mapped into the primary creatinine feature family. eICU laboratory variables were selected using exact lower-case lab names \DIFaddbegin \DIFadd{in \texttt{lab}, and vital signs were selected from named fields in \texttt{vitalPeriodic}. Temperature }\DIFaddend was normalized to Celsius for the missingness audit but excluded from modeling.

\begin{table}[h]
\DIFaddbeginFL \caption{\DIFaddFL{Explicit source mappings used for primary 24-hour shared-feature extraction}}
	...
	\begin{tabular}{>{\raggedright\arraybackslash}p{0.16\textwidth}>{\raggedright\arraybackslash}p{0.27\textwidth}>{\raggedright\arraybackslash}p{0.22\textwidth}>{\raggedright\arraybackslash}p{0.25\textwidth}}
		\hline
		\DIFaddFL{\textbf{Feature family} }& \DIFaddFL{\textbf{MIMIC source/items} }& \DIFaddFL{\textbf{eICU source/field} }& \DIFaddFL{\textbf{Restriction or unit handling} }\\ \hline
		\DIFaddFL{Glucose }& \DIFaddFL{\texttt{LABEVENTS:}}\newline \DIFaddFL{\texttt{50809, 50931} }& \DIFaddFL{\texttt{lab.labname=}}\newline \DIFaddFL{\texttt{glucose} }& \DIFaddFL{Blood/plasma/serum glucose; mg/dL retained }\\
		\DIFaddFL{Creatinine }& \DIFaddFL{\texttt{LABEVENTS:}}\newline \DIFaddFL{\texttt{50912} }& \DIFaddFL{\texttt{lab.labname=}}\newline \DIFaddFL{\texttt{creatinine} }& \DIFaddFL{Blood/serum/plasma only; urinary and protein/creatinine-ratio measurements excluded }\\
		\DIFaddFL{White blood cell count }& \DIFaddFL{\texttt{LABEVENTS:}}\newline \DIFaddFL{\texttt{51301} }& \DIFaddFL{\texttt{lab.labname=}}\newline \DIFaddFL{\texttt{wbc x 1000} }& \DIFaddFL{Blood WBC count; source-aligned count scale retained }\\
		\DIFaddFL{Hematocrit }& \DIFaddFL{\texttt{LABEVENTS:}}\newline \DIFaddFL{\texttt{50810, 51221} }& \DIFaddFL{\texttt{lab.labname=}}\newline \DIFaddFL{\texttt{hct} }& \DIFaddFL{Blood hematocrit; percent retained }\\
		\DIFaddFL{Sodium }& \DIFaddFL{\texttt{LABEVENTS:}}\newline \DIFaddFL{\texttt{50824, 50983} }& \DIFaddFL{\texttt{lab.labname=}}\newline \DIFaddFL{\texttt{sodium} }& \DIFaddFL{Blood/plasma/serum sodium; mEq/L retained }\\
		\DIFaddFL{Blood urea nitrogen }& \DIFaddFL{\texttt{LABEVENTS:}}\newline \DIFaddFL{\texttt{51006} }& \DIFaddFL{\texttt{lab.labname=}}\newline \DIFaddFL{\texttt{bun} }& \DIFaddFL{Blood urea nitrogen; mg/dL retained }\\
		\DIFaddFL{Heart rate }& \DIFaddFL{\texttt{CHARTEVENTS:}}\newline \DIFaddFL{\texttt{211, 220045} }& \DIFaddFL{\texttt{vitalPeriodic.}}\newline \DIFaddFL{\texttt{heartrate} }& \DIFaddFL{Beats/min retained }\\
		\DIFaddFL{Respiratory rate }& \DIFaddFL{\texttt{CHARTEVENTS:}}\newline \DIFaddFL{\texttt{618, 220210} }& \DIFaddFL{\texttt{vitalPeriodic.}}\newline \DIFaddFL{\texttt{respiration} }& \DIFaddFL{Breaths/min retained }\\
		\DIFaddFL{Systolic blood pressure }& \DIFaddFL{\texttt{CHARTEVENTS:}}\newline \DIFaddFL{\texttt{51, 442, 455, 220050,}}\newline \DIFaddFL{\texttt{220179, 224167, 225309, 227243} }& \DIFaddFL{\texttt{vitalPeriodic.}}\newline \DIFaddFL{\texttt{systemicsystolic} }& \DIFaddFL{mmHg retained }\\
		\DIFaddFL{Diastolic blood pressure }& \DIFaddFL{\texttt{CHARTEVENTS:}}\newline \DIFaddFL{\texttt{8368, 8440, 8441, 220051,}}\newline \DIFaddFL{\texttt{220180, 224643, 225310, 227242} }& \DIFaddFL{\texttt{vitalPeriodic.}}\newline \DIFaddFL{\texttt{systemicdiastolic} }& \DIFaddFL{mmHg retained }\\
		\DIFaddFL{Mean arterial pressure }& \DIFaddFL{\texttt{CHARTEVENTS:}}\newline \DIFaddFL{\texttt{52, 456, 220052, 220181, 225312} }& \DIFaddFL{\texttt{vitalPeriodic.}}\newline \DIFaddFL{\texttt{systemicmean} }& \DIFaddFL{mmHg retained }\\
		\DIFaddFL{Temperature }& \DIFaddFL{\texttt{CHARTEVENTS:}}\newline \DIFaddFL{Celsius \texttt{676, 677, 223762, 226329;}}\newline \DIFaddFL{Fahrenheit \texttt{678, 679, 223761} }& \DIFaddFL{\texttt{vitalPeriodic.}}\newline \DIFaddFL{\texttt{temperature} }& \DIFaddFL{Audited only; Fahrenheit converted to Celsius; excluded from primary predictors }\\ \hline
	\end{tabular}
