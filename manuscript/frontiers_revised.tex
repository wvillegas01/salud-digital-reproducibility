...
Table 2 presents the cohort flow from the outcome-resolved full-episode cohort to the primary 24-hour landmark cohort used for the main analysis. The primary analyzable cohort contained 110 MIMIC ICU stays from 79 patients and 105 admissions, with 33 in-hospital deaths (30.0\%), and 1,324 eICU ICU stays from 1,124 patients and 1,277 hospital-system stays, with 117 in-hospital deaths (8.8\%). The flow explicitly shows that 26 MIMIC ICU stays and 2,352 eICU ICU stays were excluded before landmark analysis because they did not remain observable through the first 24 hours or did not satisfy the corrected landmark-eligibility definition.

\begin{table}[h]
	\caption{Cohort flow for the primary 24-hour landmark analysis}
	\label{table:integrated_dataset_structure}
	\setlength{\tabcolsep}{4pt}
	\footnotesize
	\begin{tabular}{p{165pt}p{58pt}p{58pt}p{58pt}p{58pt}}
		\hline
		\textbf{Cohort stage} & \textbf{MIMIC ICU}\newline \textbf{stays} & \textbf{MIMIC}\newline \textbf{deaths} & \textbf{eICU ICU}\newline \textbf{stays} & \textbf{eICU}\newline \textbf{deaths} \\ \hline
		Outcome-resolved full-episode cohort & 136 & 46 & 3,676 & 310 \\
		Excluded before 24-hour landmark & 26 & 13 & 2,352 & 193 \\
		Primary 24-hour landmark cohort & 110 & 33 & 1,324 & 117 \\
		Unique patients in landmark cohort & 79 & -- & 1,124 & -- \\
		Admissions/hospital-system stays in landmark cohort & 105 & -- & 1,277 & -- \\ \hline
	\end{tabular}
\end{table}
