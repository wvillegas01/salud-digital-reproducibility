...
\textcolor{red}{The results show that, under the primary 24-hour shared-feature specification, all models had limited cross-domain transportability. In Train eICU $\rightarrow$ Test MIMIC, Random Forest produced no positive predictions at the fixed 0.5 threshold; however, this same threshold failure was already present during internal eICU validation, so it cannot be attributed exclusively to transfer. Logistic Regression retained partial sensitivity with substantial false-positive burden, whereas Gradient Boosting crossed the threshold for only three MIMIC cases.} These findings demonstrate that performance degradation is not only manifested in global metrics but also in the structure of the decision-making process itself, highlighting the importance of analyzing the relationship between the probability distribution and the classification threshold. This work contributes to the state of the art by \textcolor{red}{empirically characterizing fixed-threshold decision failure under clinical dataset shift, while distinguishing failures already present in the source domain from those amplified during transfer, rather than proposing probability-threshold analysis as a new mathematical construct,} and provides a methodological basis for developing more robust and reliable systems in real-world settings.
...
The composition of the integrated dataset reveals a marked asymmetry between the sources. The full integrated dataset is dominated by eICU, with 4,358 records, compared to 136 in MIMIC, representing a difference of more than one order of magnitude. This relationship persists after cleaning, with the clean dataset containing 3,812 valid instances, thereby preserving eICU's dominance as the primary source of information.
...
\textcolor{red}{The primary retained variable set does not assume that a 29-column structural matrix is equivalent to clinical harmonization. Instead, the primary 24-hour model uses 35 pre-encoding predictors derived from 11 shared clinical variable families plus age and gender. Temperature was not retained in the primary shared-feature matrix because eICU missingness was 91.8\% after applying the 24-hour landmark definition. The secondary 29-variable full-episode matrix is described as a retrospective specification. The strict full-episode shared-feature sensitivity model used 16 pre-encoding predictors, corresponding to age, gender, and mean/standard-deviation summaries for seven shared clinical variable families. In these matrices, completeness was not identical across sources: \texttt{hospitalid}, \texttt{apachescore}, \texttt{predictedhospitalmortality}, and some pressure summaries were not equivalent across MIMIC and eICU. Conversely, core vital-sign and laboratory summaries were present in both sources with low-to-moderate missingness. This pattern indicates that structural column alignment alone is insufficient as evidence of measurement equivalence.}
...
\textcolor{red}{Figure~\ref{fig:fig3}(d) presents the systolic blood-pressure distributions in MIMIC and eICU, completing the comparison using variables included in the primary shared-feature specification. The distributions overlap in the central range but differ in spread and tail behavior, reinforcing that nominally shared variables may still have different empirical distributions across source systems.}

\subsection{\textcolor{red}{Primary 24-hour shared-feature performance}}

\textcolor{red}{The primary analysis used the 24-hour landmark cohort and only predictors observed in both MIMIC and eICU. This specification was prioritized over the secondary full-episode/full-feature analysis because it reduces temporal leakage risk and avoids eICU-specific predictors such as \texttt{predictedhospitalmortality}, \texttt{apachescore}, and \texttt{hospitalid}. The performance of the models under intra-environment conditions is presented in Table~\ref{tab:intra_environment_performance}, considering both internal validation on eICU and integrated cross-validation.}
...
\begin{table}[h]
	...
	\begin{tabular}{lllllll}
		...
		\textcolor{red}{eICU internal validation} & \textcolor{red}{LogisticRegression} & \textcolor{red}{0.743} & \textcolor{red}{0.189} & \textcolor{red}{0.586} & \textcolor{red}{0.286} & \textcolor{red}{0.715} \\
		\textcolor{red}{eICU internal validation} & \textcolor{red}{RandomForest} & \textcolor{red}{0.912} & \textcolor{red}{NA} & \textcolor{red}{0.000} & \textcolor{red}{0.000} & \textcolor{red}{0.765} \\
		\textcolor{red}{eICU internal validation} & \textcolor{red}{GradientBoosting} & \textcolor{red}{0.897} & \textcolor{red}{0.222} & \textcolor{red}{0.069} & \textcolor{red}{0.105} & \textcolor{red}{0.734} \\
		
		\textcolor{red}{Integrated 5-fold CV} & \textcolor{red}{LogisticRegression} & \textcolor{red}{$0.699 \pm 0.031$} & \textcolor{red}{$0.196 \pm 0.023$} & \textcolor{red}{$0.600 \pm 0.070$} & \textcolor{red}{$0.295 \pm 0.032$} & \textcolor{red}{$0.717 \pm 0.055$} \\
		
		\textcolor{red}{Integrated 5-fold CV} & \textcolor{red}{RandomForest} & \textcolor{red}{$0.895 \pm 0.002$} & \textcolor{red}{$0.200 \pm 0.400$} & \textcolor{red}{$0.007 \pm 0.013$} & \textcolor{red}{$0.013 \pm 0.026$} & \textcolor{red}{$0.715 \pm 0.032$} \\
		
		\textcolor{red}{Integrated 5-fold CV} & \textcolor{red}{GradientBoosting} & \textcolor{red}{$0.884 \pm 0.020$} & \textcolor{red}{$0.377 \pm 0.290$} & \textcolor{red}{$0.080 \pm 0.050$} & \textcolor{red}{$0.130 \pm 0.086$} & \textcolor{red}{$0.708 \pm 0.062$} \\ \hline
...
\textcolor{red}{In the primary 24-hour shared-feature internal validation scenario on eICU, apparent performance was much more modest than in the secondary full-episode analysis. Logistic Regression produced the highest recall (0.586) but low precision (0.189), indicating many false-positive activations. Random Forest achieved high accuracy (0.912) and moderate AUC-ROC (0.765), but generated no positive predictions at the fixed 0.5 threshold; precision is therefore reported as NA rather than zero because TP+FP=0. Gradient Boosting showed similar discrimination (AUC-ROC 0.734) but very low recall (0.069).}

\textcolor{red}{In integrated five-fold cross-validation, AUC-ROC values remained in the range 0.708--0.717, but threshold-dependent minority-class metrics were weak for tree-based models. Random Forest had recall $0.007 \pm 0.013$ and F1-score $0.013 \pm 0.026$, while Gradient Boosting had recall $0.080 \pm 0.050$ and F1-score $0.130 \pm 0.086$. Logistic Regression again favored sensitivity over precision, with recall $0.600 \pm 0.070$ and precision $0.196 \pm 0.023$. These values indicate that the clinically stricter landmark/shared-feature design substantially reduces the apparent performance observed in the secondary full-episode/full-feature results.}
...
\begin{table}[h]
	...
	\begin{tabular}{p{140pt}p{50pt}p{50pt}p{50pt}p{45pt}p{45pt}p{60pt}}
		...
		\textcolor{red}{Train eICU $\rightarrow$ Test MIMIC} & \textcolor{red}{Logistic} & \textcolor{red}{0.564} & \textcolor{red}{0.353} & \textcolor{red}{0.545} & \textcolor{red}{0.429} & \textcolor{red}{0.598} \\
		\textcolor{red}{Train eICU $\rightarrow$ Test MIMIC} & \textcolor{red}{RF} & \textcolor{red}{0.700} & \textcolor{red}{NA} & \textcolor{red}{0.000} & \textcolor{red}{0.000} & \textcolor{red}{0.642} \\
		\textcolor{red}{Train eICU $\rightarrow$ Test MIMIC} & \textcolor{red}{GB} & \textcolor{red}{0.709} & \textcolor{red}{0.667} & \textcolor{red}{0.061} & \textcolor{red}{0.111} & \textcolor{red}{0.609} \\
		
		\textcolor{red}{Train MIMIC $\rightarrow$ Test eICU} & \textcolor{red}{Logistic} & \textcolor{red}{0.626} & \textcolor{red}{0.094} & \textcolor{red}{0.376} & \textcolor{red}{0.151} & \textcolor{red}{0.539} \\
		\textcolor{red}{Train MIMIC $\rightarrow$ Test eICU} & \textcolor{red}{RF} & \textcolor{red}{0.888} & \textcolor{red}{0.103} & \textcolor{red}{0.034} & \textcolor{red}{0.051} & \textcolor{red}{0.592} \\
		\textcolor{red}{Train MIMIC $\rightarrow$ Test eICU} & \textcolor{red}{GB} & \textcolor{red}{0.755} & \textcolor{red}{0.112} & \textcolor{red}{0.256} & \textcolor{red}{0.156} & \textcolor{red}{0.555} \\ \hline
...
\begin{table}[h]
	...
	\begin{tabular}{llllllll}
		...
		\textcolor{red}{E2M} & \textcolor{red}{LR} & \textcolor{red}{0.353} & \textcolor{red}{0.545 [0.364, 0.719]} & \textcolor{red}{0.571 [0.454, 0.684]} & \textcolor{red}{0.429 [0.313, 0.549]} & \textcolor{red}{0.598 [0.479, 0.719]} & \textcolor{red}{0.269 [0.225, 0.314]} \\
		\textcolor{red}{E2M} & \textcolor{red}{RF} & \textcolor{red}{NA} & \textcolor{red}{0.000 [0.000, 0.106]} & \textcolor{red}{1.000 [0.953, 1.000]} & \textcolor{red}{0.000 [0.000, 0.000]} & \textcolor{red}{0.642 [0.524, 0.756]} & \textcolor{red}{0.241 [0.226, 0.255]} \\
		\textcolor{red}{E2M} & \textcolor{red}{GB} & \textcolor{red}{0.667} & \textcolor{red}{0.061 [0.007, 0.202]} & \textcolor{red}{0.987 [0.930, 1.000]} & \textcolor{red}{0.111 [0.000, 0.263]} & \textcolor{red}{0.609 [0.482, 0.735]} & \textcolor{red}{0.241 [0.215, 0.264]} \\
		\textcolor{red}{M2E} & \textcolor{red}{LR} & \textcolor{red}{0.094} & \textcolor{red}{0.376 [0.288, 0.470]} & \textcolor{red}{0.650 [0.623, 0.677]} & \textcolor{red}{0.151 [0.116, 0.183]} & \textcolor{red}{0.539 [0.480, 0.593]} & \textcolor{red}{0.244 [0.231, 0.258]} \\
		\textcolor{red}{M2E} & \textcolor{red}{RF} & \textcolor{red}{0.103} & \textcolor{red}{0.034 [0.009, 0.085]} & \textcolor{red}{0.971 [0.960, 0.980]} & \textcolor{red}{0.051 [0.013, 0.105]} & \textcolor{red}{0.592 [0.541, 0.645]} & \textcolor{red}{0.130 [0.126, 0.134]} \\
		\textcolor{red}{M2E} & \textcolor{red}{GB} & \textcolor{red}{0.112} & \textcolor{red}{0.256 [0.180, 0.345]} & \textcolor{red}{0.804 [0.780, 0.826]} & \textcolor{red}{0.156 [0.109, 0.203]} & \textcolor{red}{0.555 [0.497, 0.609]} & \textcolor{red}{0.181 [0.168, 0.195]} \\ \hline
	\end{tabular}%
	}
\end{table}
...
\begin{table}[h]
	...
	\begin{tabular}{llllllllll}
		...
		\textcolor{red}{eICU internal} & \textcolor{red}{LR} & \textcolor{red}{0.556} & \textcolor{red}{0.716} & \textcolor{red}{0.248} & \textcolor{red}{0.708} & \textcolor{red}{0.251} & \textcolor{red}{0.198} & \textcolor{red}{0.300} & \textcolor{red}{-2.250/0.585} \\
		\textcolor{red}{eICU internal} & \textcolor{red}{RF} & \textcolor{red}{0.009} & \textcolor{red}{0.998} & \textcolor{red}{0.017} & \textcolor{red}{0.694} & \textcolor{red}{0.162} & \textcolor{red}{0.079} & \textcolor{red}{0.026} & \textcolor{red}{-0.765/0.618} \\
		\textcolor{red}{eICU internal} & \textcolor{red}{GB} & \textcolor{red}{0.060} & \textcolor{red}{0.983} & \textcolor{red}{0.097} & \textcolor{red}{0.743} & \textcolor{red}{0.211} & \textcolor{red}{0.081} & \textcolor{red}{0.037} & \textcolor{red}{-0.703/0.587} \\
		\textcolor{red}{E2M transfer} & \textcolor{red}{LR} & \textcolor{red}{0.545} & \textcolor{red}{0.571} & \textcolor{red}{0.429} & \textcolor{red}{0.598} & \textcolor{red}{0.402} & \textcolor{red}{0.269} & \textcolor{red}{0.235} & \textcolor{red}{-0.848/0.255} \\
		\textcolor{red}{E2M transfer} & \textcolor{red}{RF} & \textcolor{red}{0.000} & \textcolor{red}{1.000} & \textcolor{red}{0.000} & \textcolor{red}{0.642} & \textcolor{red}{0.438} & \textcolor{red}{0.241} & \textcolor{red}{0.200} & \textcolor{red}{-0.620/0.086} \\
		\textcolor{red}{E2M transfer} & \textcolor{red}{GB} & \textcolor{red}{0.061} & \textcolor{red}{0.987} & \textcolor{red}{0.111} & \textcolor{red}{0.609} & \textcolor{red}{0.467} & \textcolor{red}{0.241} & \textcolor{red}{0.219} & \textcolor{red}{0.109/0.354} \\
		\textcolor{red}{MIMIC internal} & \textcolor{red}{LR} & \textcolor{red}{0.394} & \textcolor{red}{0.597} & \textcolor{red}{0.338} & \textcolor{red}{0.503} & \textcolor{red}{0.401} & \textcolor{red}{0.289} & \textcolor{red}{0.251} & \textcolor{red}{-0.821/0.107} \\
		\textcolor{red}{MIMIC internal} & \textcolor{red}{RF} & \textcolor{red}{0.061} & \textcolor{red}{0.948} & \textcolor{red}{0.103} & \textcolor{red}{0.535} & \textcolor{red}{0.338} & \textcolor{red}{0.217} & \textcolor{red}{0.098} & \textcolor{red}{-0.583/0.282} \\
		\textcolor{red}{MIMIC internal} & \textcolor{red}{GB} & \textcolor{red}{0.212} & \textcolor{red}{0.844} & \textcolor{red}{0.269} & \textcolor{red}{0.593} & \textcolor{red}{0.382} & \textcolor{red}{0.258} & \textcolor{red}{0.214} & \textcolor{red}{-0.553/0.156} \\
		\textcolor{red}{M2E transfer} & \textcolor{red}{LR} & \textcolor{red}{0.376} & \textcolor{red}{0.650} & \textcolor{red}{0.151} & \textcolor{red}{0.539} & \textcolor{red}{0.123} & \textcolor{red}{0.244} & \textcolor{red}{0.323} & \textcolor{red}{-2.293/0.113} \\
		\textcolor{red}{M2E transfer} & \textcolor{red}{RF} & \textcolor{red}{0.034} & \textcolor{red}{0.971} & \textcolor{red}{0.051} & \textcolor{red}{0.592} & \textcolor{red}{0.117} & \textcolor{red}{0.130} & \textcolor{red}{0.211} & \textcolor{red}{-1.792/0.653} \\
		\textcolor{red}{M2E transfer} & \textcolor{red}{GB} & \textcolor{red}{0.256} & \textcolor{red}{0.804} & \textcolor{red}{0.156} & \textcolor{red}{0.555} & \textcolor{red}{0.107} & \textcolor{red}{0.181} & \textcolor{red}{0.198} & \textcolor{red}{-2.204/0.085} \\ \hline
	\end{tabular}%	
	}
\end{table}

\textcolor{red}{Because the MIMIC source cohort is small (110 landmark ICU episodes with 33 deaths), internal MIMIC validation was treated as an unstable diagnostic rather than as definitive evidence of source-domain performance. In 20 repeats of stratified five-fold cross-validation, AUC-ROC means were 0.474 for Logistic Regression, 0.585 for Random Forest, and 0.552 for Gradient Boosting, with fold-level standard deviations of 0.137, 0.109, and 0.119, respectively. Random Forest produced zero positive predictions in 22 of 100 folds and Gradient Boosting in 1 of 100 folds, whereas Logistic Regression did not produce zero-positive folds. Patient-grouped five-fold internal validation further reduced apparent MIMIC performance: AUC-ROC was 0.404 for Logistic Regression, 0.525 for Random Forest, and 0.506 for Gradient Boosting. This analysis indicates that the MIMIC-to-eICU transfer results should be interpreted against a weak and unstable MIMIC source model, not as a clean demonstration of degradation from a strong source-domain baseline.}

\textcolor{red}{As a secondary diagnostic for the secondary full-episode/full-feature specification, calibration and post hoc threshold sensitivity were also evaluated. This analysis is not treated as an operational threshold-selection procedure because the F1-maximizing thresholds were selected using the labeled test sets; it is therefore an oracle/post hoc diagnostic used only to assess whether ranking information remained below the fixed conventional 0.5 threshold. In Train eICU $\rightarrow$ Test MIMIC, average precision was 0.541 for Random Forest and 0.559 for Gradient Boosting, confirming that some ranking information remained despite zero positive predictions at $\tau=0.5$. Calibration gaps were nevertheless large: five-bin expected calibration error was 0.258 for Random Forest, 0.285 for Gradient Boosting, and 0.183 for Logistic Regression. Calibration intercept/slope were 1.964/1.030 for Random Forest, 1.886/0.802 for Gradient Boosting, and -0.542/0.082 for Logistic Regression. Post hoc F1-maximizing thresholds were much lower than 0.5 for the tree-based models (0.067 for Random Forest and 0.027 for Gradient Boosting), recovering recall values of 0.783 and 0.826, respectively, but with only moderate precision (0.480 and 0.469) and specificity near 0.56 and 0.52. These results indicate that the transferred models were not devoid of all ordering information; rather, their probability scale was poorly aligned with the fixed conventional threshold.}

\textcolor{red}{The full-feature 24-hour landmark sensitivity analysis, which retained variables when structurally present in the broader feature table, is shown in Table~\ref{tab:landmark_24h_transfer}. Its results were similar to the primary shared-feature landmark analysis for Random Forest and Gradient Boosting, but Logistic Regression became more sensitive in eICU-to-MIMIC transfer (24 true positives, recall 0.727) at the cost of lower specificity (36 true negatives and 41 false positives). Gradient Boosting again crossed the threshold for only three MIMIC cases (2 true positives and 1 false positive). This reinforces the conclusion that fixed-threshold behavior is sensitive to feature-alignment decisions, whereas Random Forest repeatedly shows a highly conservative fixed-threshold operating point that is visible before and after transfer.}
...
\begin{table}[h]
	...
	\begin{tabular}{lllllll}
		...
		\textcolor{red}{E2M} & \textcolor{red}{Logistic} & \textcolor{red}{0.545} & \textcolor{red}{0.369} & \textcolor{red}{0.727} & \textcolor{red}{0.490} & \textcolor{red}{0.590} \\
		\textcolor{red}{E2M} & \textcolor{red}{RF} & \textcolor{red}{0.700} & \textcolor{red}{0.000} & \textcolor{red}{0.000} & \textcolor{red}{0.000} & \textcolor{red}{0.631} \\
		\textcolor{red}{E2M} & \textcolor{red}{GB} & \textcolor{red}{0.709} & \textcolor{red}{0.667} & \textcolor{red}{0.061} & \textcolor{red}{0.111} & \textcolor{red}{0.631} \\
		\textcolor{red}{M2E} & \textcolor{red}{Logistic} & \textcolor{red}{0.662} & \textcolor{red}{0.107} & \textcolor{red}{0.385} & \textcolor{red}{0.168} & \textcolor{red}{0.539} \\
		\textcolor{red}{M2E} & \textcolor{red}{RF} & \textcolor{red}{0.888} & \textcolor{red}{0.103} & \textcolor{red}{0.034} & \textcolor{red}{0.051} & \textcolor{red}{0.621} \\
		\textcolor{red}{M2E} & \textcolor{red}{GB} & \textcolor{red}{0.798} & \textcolor{red}{0.139} & \textcolor{red}{0.248} & \textcolor{red}{0.178} & \textcolor{red}{0.573} \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[h]
	...
	\begin{tabular}{p{145pt}p{50pt}p{35pt}p{35pt}p{35pt}p{35pt}p{55pt}p{55pt}}
		...
		\textcolor{red}{Train eICU $\rightarrow$ Test MIMIC} & \textcolor{red}{Logistic} & \textcolor{red}{44} & \textcolor{red}{33} & \textcolor{red}{15} & \textcolor{red}{18} & \textcolor{red}{0.545} & \textcolor{red}{0.571} \\
		\textcolor{red}{Train eICU $\rightarrow$ Test MIMIC} & \textcolor{red}{RF} & \textcolor{red}{77} & \textcolor{red}{0} & \textcolor{red}{33} & \textcolor{red}{0} & \textcolor{red}{0.000} & \textcolor{red}{1.000} \\
		\textcolor{red}{Train eICU $\rightarrow$ Test MIMIC} & \textcolor{red}{GB} & \textcolor{red}{76} & \textcolor{red}{1} & \textcolor{red}{31} & \textcolor{red}{2} & \textcolor{red}{0.061} & \textcolor{red}{0.987} \\
		
		\textcolor{red}{Train MIMIC $\rightarrow$ Test eICU} & \textcolor{red}{Logistic} & \textcolor{red}{785} & \textcolor{red}{422} & \textcolor{red}{73} & \textcolor{red}{44} & \textcolor{red}{0.376} & \textcolor{red}{0.650} \\
		\textcolor{red}{Train MIMIC $\rightarrow$ Test eICU} & \textcolor{red}{RF} & \textcolor{red}{1172} & \textcolor{red}{35} & \textcolor{red}{113} & \textcolor{red}{4} & \textcolor{red}{0.034} & \textcolor{red}{0.971} \\
		\textcolor{red}{Train MIMIC $\rightarrow$ Test eICU} & \textcolor{red}{GB} & \textcolor{red}{970} & \textcolor{red}{237} & \textcolor{red}{87} & \textcolor{red}{30} & \textcolor{red}{0.256} & \textcolor{red}{0.804} \\ \hline
